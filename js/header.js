...
function initHeader() {
  ...
  const titles = [
    ...
    "Bigc bheese",
    "I'm just a mannnn - Ody",
    "I provide 720 degrees of value",
    "*foxy jumpscare*",
    "gouda",
    "this header is the peak of professionalism",
    "all i hear are screams",
    "Maybe the true Arcane was the friends we made along the way",
    ...
    "A very small pebble can turn a wheel out of its path, but it is often an unpleasant experience for the pebble.",
    "Enduring the boredom, the messiness, and the inconvenience of doing what is right.",
